...
exports.updateVideoData = exports.delMainVidData = exports.delVidData = exports.appendInvVidID = exports.delRedditData = exports.getInvVideoIds = exports.getTotalVideoTime = exports.getTotalRedditTime = exports.selectAllFromReddit = exports.selectAllFromMainVideo = exports.selectAllFromVideo = exports.pullAllInvRedditIDs = exports.pullAllVidIDs = exports.appendMainVideoItem = exports.appendVideoItem = exports.updateRedditPost = exports.appendRedditPost = exports.appendInvalidID = void 0;
var sqlite3 = require("sqlite3");
var TABLE_NAMES;
(function (TABLE_NAMES) {
    TABLE_NAMES["reddit_cont"] = "reddit_cont";
    TABLE_NAMES["mainVideo_cont"] = "mainVideo_cont";
...
var appendMainVideoItem = function (arg) {
    var insertSql = "INSERT INTO ".concat(TABLE_NAMES.mainVideo_cont, " (videoID, videoLen, videoName) VALUES (?, ?, ?)");
    db.run(insertSql, [arg.videoID, arg.videoLen, arg.videoName], function (err) {
        if (err) {
            console.log(err.message);
        }
...
exports.appendMainVideoItem = appendMainVideoItem;
...
var selectAllFromMainVideo = function (limit) {
    return new Promise(function (res, rej) {
        db.all("SELECT * FROM mainVideo_cont LIMIT ".concat(limit), function (err, row) {
            if (err) {
                return rej(err);
            }
            else {
...
exports.selectAllFromMainVideo = selectAllFromMainVideo;
...
var delMainVidData = function (videoID) {
    var deleteSql = "DELETE FROM ".concat(TABLE_NAMES.mainVideo_cont, " WHERE videoID = \"").concat(videoID, "\"");
    db.run(deleteSql, function (err) {
        if (err) {
            console.log(err.message);
        }
...
exports.delMainVidData = delMainVidData;
